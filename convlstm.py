...
class SequentialDataset:
    ...
    def dataset_generator(self, json_path, mode='all'):
        ...
        dataset = tf.data.Dataset.from_generator(
            generator=lambda: sequence_generator(),
...
class BathroomDataset(SequentialDataset):
    ...
    def load_sequences_from_json(self, json_path):
...
if __name__ == '__main__':
    ...
    #JSON_PATH = os.path.join(BASE_DIR, 'data', 'sitStandCombinedData.json')
    ...
    dataset.load_sequences_from_json(JSON_PATH)

    # Preprocess Datasets
    train_ds   = dataset.dataset_generator(JSON_PATH, 'train')
    valid_ds   = dataset.dataset_generator(JSON_PATH, 'valid')
